...
public class CalculatorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Set OnClickListener for the dateButton
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Set OnClickListener for the horoscopeBtn using lambda expression
        ...
        // Set OnClickListener for the homeBtn using lambda expression
        homeBtn.setOnClickListener(v -> {
            Navigation.findNavController(view).navigate(R.id.action_calculatorFragment_to_mainFragment);
        });
    }

    // Function to calculate and display the Zodiac sign based on user input
    private void calculateZodiacSign() {
        // Get the date in DD/MM format from the user input
    ...
    // Function to determine the Zodiac sign based on the day and month
